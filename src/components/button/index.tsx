...
const Component = (props: IComponentProps) => {
  return (
    <div className="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center bg-gray-100 font-sans py-6">
      <div className="container">
        ...
        <div className="card bg-white py-3 px-5 rounded-xl flex flex-col mb-5">
          ...
          <div className="w-full py-3">
            <div className="flex inline-flex mr-2" role="group">
